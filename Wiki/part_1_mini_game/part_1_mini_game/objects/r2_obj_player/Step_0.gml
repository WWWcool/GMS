...
if (move_x != 0 || move_y != 0)
{
	...
	if(place_meeting(x + hspd,y,r2_obj_wall))
	{
		while(!place_meeting(x + sign(hspd),y,r2_obj_wall))
		{
			x += sign(hspd);
		}
		buf_x = x;
	...
	if(place_meeting(x,y + vspd,r2_obj_wall))
	{
		while(!place_meeting(x,y + sign(vspd),r2_obj_wall))
		{
			y += sign(vspd);
		}
		buf_y = y;
